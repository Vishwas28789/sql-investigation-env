...
| Task | Broken Query Score | Expected Perfect Score |
|------|-------------------|----------------------|
| Task 1 (Syntax) | 0.0 | 1.0 |
| Task 2 (Logic) | 0.0 | 1.0 |
| Task 3 (Hard) | 0.0 | 1.0 |
| **Average** | **0.0** | **1.0** |

*Baseline scores are generated by running `/baseline` endpoint on submission.*
